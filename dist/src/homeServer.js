...
var HomeServer = /** @class */ (function () {
    ...
    HomeServer.prototype.getSocketPath = function () {
        var _a, _b;
        var url = new URL(this.ip);
        url.protocol = ((_a = this.settings) === null || _a === void 0 ? void 0 : _a.SSL) ? "wss:" : "ws";
        url.port = ((_b = this.settings) === null || _b === void 0 ? void 0 : _b.port) || "";
        url.pathname = "/api/socket";
        return url;
    };
    HomeServer.prototype.loginWithEmail = function (email, password) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, reqHelper_1.ReqHelper.post(this.API(Kit.CORE, 1, "login").toString(), null, {
                        email: email,
                        password: password,
                    })];
            });
    ...
    HomeServer.prototype.loginWithToken = function (origin, token) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, reqHelper_1.ReqHelper.post(this.API(Kit.CORE, 1, "login").toString(), null, {
